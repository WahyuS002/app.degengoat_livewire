                                ...
                                @if ($active_notification)
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap w-1/3">
                                            <div class="font-semibold text-gray-900">Lorem ipsum dolor sit amet. lorem</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap w-1/3">
                                            <div class="flex items-center space-x-5">
                                                <div class="flex flex-col w-auto">
                                                    <p class="text-left text-gray-900 font-medium text-sm">02 Jan 08:15</p>
                                                    <p class="text-right text-sm text-gray-500">EST</p>
                                                </div>
                                                <span class="w-12 bg-gray-500 h-[1.1px]"></span>
                                                <div class="flex flex-col w-auto">
                                                    <p class="text-left text-gray-900 font-medium text-sm">03 Jan 08:15</p>
                                                    <p class="text-right text-sm text-gray-500">EST</p>
                                                </div>
                                            </div>
                                        </td>
